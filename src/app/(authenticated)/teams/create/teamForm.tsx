...
import {createTeamAction} from '@/serverFunctions/teams'
...
const TeamForm: FunctionComponent<TeamFormProps> = ({images}) => {
  const [form, createTeam] = useZodValidatedForm(createTeamSchema, createTeamAction)
  ...
  return (
    <Card className="mx-auto max-w-2xl">
      ...
      <CardContent>
        <Form hookForm={form} className="space-y-6" action={createTeam}>

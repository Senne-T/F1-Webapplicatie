...
import {createDriverAction} from '@/serverFunctions/drivers'
...
const DriverForm: FunctionComponent<DriverFormProps> = ({teams, images}) => {
  const [form, createDriver] = useZodValidatedForm(createDriverSchema, createDriverAction)
  ...
  return (
    <Card className="mx-auto max-w-2xl">
      ...
      <CardContent>
        <Form hookForm={form} className="space-y-6" action={createDriver}>
